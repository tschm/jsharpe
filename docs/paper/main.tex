...
$1 + \log K$ inflation, off by a factor of $39$ at $K = 200$. We give the
one-line repairs for each and a simulation harness that would have caught all
three.
\end{abstract}
...
exposes is the real one: controlling the false-discovery rate at $5\%$ on a
$5\%$ prior costs all but $24\%$ of the power.
